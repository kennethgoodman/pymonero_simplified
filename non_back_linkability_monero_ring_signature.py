...
def get_ring_signature(pks, secret_key_index, M, sk):
	...
	for new_idx, prev_idx in loop_around_n_from_starting(size_of_ring, secret_key_index + 2):
		...
		temp_2 = secrets[prev_idx] * h_p_R + c[prev_idx] * key_image
		c[new_idx] = H_n(R, key_image, M, temp_1, temp_2)
	secrets[secret_key_index] = c[secret_key_index] * sk - random_priv_key
